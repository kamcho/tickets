...
def create_customer_user(contact_name, email, phone, password, address='', location=''):
    """Create or update MyUser with role=Customer."""
    ...
    if user:
        ...
        normalized = normalize_kenya_phone(phone) or phone.strip()
        user.phone = normalized or user.phone
        ...
        if password:
            user = User.objects.create_user(
                ...
                phone=normalize_kenya_phone(phone) or phone.strip(),
                role='Customer',
                address=address or '',
